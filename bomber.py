...
def banner():
    print(bcolors.GREEN + '+[+[+[ MAIL BOMB MN 3XP101T v1.0 ]+]+]+')
    print(bcolors.GREEN + '+[+[+[ HACK ]+]+]+')
    print(bcolors.GREEN + '''
...
class Email_Bomber:
    ...
    def __init__(self):
        try:
            ...
            self.mode = int(input(bcolors.GREEN + 'Enter BOMB mode (1,2,3,4,5) || 1:(1000) 2:(500) 3:(250) 4:(10000) 5:(custom) <: '))
